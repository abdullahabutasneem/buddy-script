			...
			<nav className="navbar navbar-expand-lg navbar-light _header_nav _padd_t10">
				<div className="container _custom_container">
					<div className="_logo_wrap">
						<Link className="navbar-brand" href="/feed" prefetch={false}>
					...
					>
						...
						<ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
							<li className="nav-item _header_nav_item">
								<Link className="nav-link _header_nav_link_active _header_nav_link" aria-current="page" href="/feed" prefetch={false}>
							...
							<li className="nav-item _header_nav_item">
								<Link className="nav-link _header_nav_link" href="/friends" prefetch={false}>
							...
							<li className="nav-item _header_nav_item">
								<Link className="nav-link _header_nav_link" href="/messages" prefetch={false}>
						...
						<div className="_header_nav_profile">
							<div
								className="_header_nav_profile_image feed-header-profile-trigger"
								role="button"
								tabIndex={0}
							...
							<div className="_header_nav_dropdown">
								<p
									className="_header_nav_para feed-header-profile-trigger"
									role="button"
									tabIndex={0}
									onClick={onProfileToggleClick}
									onKeyDown={(e) => {
							...
							<div
								id="_prfoile_drop"
								className={profileDropdownClassName}
								...
								<div className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
									<div className="_header_mobile_menu_top_inner">
										<div className="_header_mobile_menu_logo">
											<Link href="/feed" className="_mobile_logo_link" prefetch={false}>
												<img src="/assets/images/logo.svg" alt="Buddy Script" className="_nav_logo" />
											</Link>
										</div>
							...
							<div className="col-xl-12 col-lg-12 col-md-12">
								<ul className="_mobile_navigation_bottom_list">
									<li className="_mobile_navigation_bottom_item">
										<Link href="/feed" className="_mobile_navigation_bottom_link _mobile_navigation_bottom_link_active" prefetch={false}>
									...
									<li className="_mobile_navigation_bottom_item">
										<Link href="/friends" className="_mobile_navigation_bottom_link" prefetch={false}>
									...
									<li className="_mobile_navigation_bottom_item">
										<Link href="/messages" className="_mobile_navigation_bottom_link" prefetch={false}>
											<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
