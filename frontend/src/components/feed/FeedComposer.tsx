...
export function FeedComposer({ onPostCreated, userAvatar }: FeedComposerProps) {
  ...
  const textId = "buddy-feed-floating-textarea";
  ...
  async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    if (!text.trim() && !file) {
      setSubmitError("Enter text or choose a photo");
      return;
    }
  ...
  return (
    ...
    >
      ...
      <div className="_feed_inner_text_area_box">
        <button
          type="button"
          className="_feed_inner_text_area_box_image border-0 bg-transparent p-0"
        ...
        <div className="form-floating _feed_inner_text_area_box_form ">
          <textarea
            ...
            maxLength={5000}
          />
          <label className="_feed_textarea_label" htmlFor={textId}>
            Write something ...
            <svg
      ...
      <p className="_feed_inner_timeline_post_box_para _mar_t8 _mar_b8">
        <span className="me-2">Audience:</span>
        <label className="me-3 cursor-pointer">
          <input
            type="radio"
            name="buddy-visibility"
